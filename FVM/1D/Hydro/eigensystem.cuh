...
extern int NUMB_WAVE;
 ...
 void eigenvalues(double3 V,double lambda[NUMB_WAVE]){
    double  a, u;
    // sound speed
  ...
  void right_eigenvectors(double3 V,bool conservative, double3 reig[NUMB_WAVE]){
  //Right Eigenvectors
...
void left_eigenvectors(double3 V,bool conservative, double3 leig[NUMB_WAVE]){ 
//Left Eigenvectors
